...
!----------------------------------------------------------------
      module NumConstclass
        ...
        integer, parameter :: Nplcmax = 1000000
        ...
        integer, parameter :: Nblemtmax = 10000
        !maximum # of drift space
        integer, parameter :: Ndriftmax = 10000
        ...
        !maximum # of rf gaps
        integer, parameter :: Ncclmax = 10000
        ...
        integer, parameter :: Nbpmmax = 10000
        !maximum # of magnetic solenoid
        integer, parameter :: Nslmax = 10000
