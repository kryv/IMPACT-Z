...
!        use mpistub
      ...
      contains
        ...
        if (incol .ne. ncol .or. inrow .ne. nrow) then
            call MPI_CART_CREATE(comm,2,dims,period,.true.,this%comm_2d,ierr)
            incol = ncol
            inrow = nrow
        endif
