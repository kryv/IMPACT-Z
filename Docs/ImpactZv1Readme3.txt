...
To run the IMPACT code, the user needs to prepare some input files.
There are a few utility programs under:
http://amac.lbl.gov/~jiqiang/IMPACT/ilinac/utilities/
...
http://amac.lbl.gov/~jiqiang/IMPACT/ilinac/examples/
