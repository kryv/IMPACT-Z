          ...
          if(ip.ne.npz) then
            if(i.le.Ndiv) then
              ...
              lctabrgz(2,ip) = zmin + (inzglb-1)*hz - 0.5*hz + &
                               (i+Ndiv-Ndiv*inzglb)*hz/float(Ndiv)
            endif
          endif
        enddo
        ...
        do i = 1, nozero-1
          if((nozeronmz(i+1)-nozeronmz(i)).gt.1) then
            ...
            do i0 = 1, nozeronmz(i+1)-nozeronmz(i)-1
              ...
              float((nozeronmz(i+1)-nozeronmz(i)))
            enddo
          endif
        enddo
        endif
          ...
          if(ip.ne.npy) then
            if(i.le.Ndiv) then
              ...
              lctabrgy(2,ip) = ymin + (inyglb-1)*hy - 0.5*hy + &
                               (i+Ndiv-Ndiv*inyglb)*hy/float(Ndiv)
            endif
          endif
        enddo
        ...
        do i = 1, nozero-1
          if((nozeronmy(i+1)-nozeronmy(i)).gt.1) then
            ...
            do i0 = 1, nozeronmy(i+1)-nozeronmy(i)-1
              ...
              float((nozeronmy(i+1)-nozeronmy(i)))
            enddo
          endif
        enddo
        endif
